...
function LoginForm() {
  ...
  return (
    <Container
      fluid
      className="d-flex flex-row min-vh-100 justify-content-center align-items-center p-0 position-relative"
    >
      ...
      <div className="position-absolute w-100" style={{ bottom: "20px" }}>
        <Row className="w-100 justify-content-center m-0">
          ...
          >
            <Button onClick={handleAdminLogin} className="w-100 mb-2">
              Ja sam Admin
            </Button>
