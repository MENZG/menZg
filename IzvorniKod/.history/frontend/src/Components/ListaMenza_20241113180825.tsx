...
const Menze = ({ menze }: { menze: any[] }) => {
  const today = new Date().getDay(); // broj dana u tjednu (0 = Nedjelja, 1 = Ponedjeljak, ...)
  const todayName = daysOfWeek[today]; // naziv dana u tjednu na temelju broja
