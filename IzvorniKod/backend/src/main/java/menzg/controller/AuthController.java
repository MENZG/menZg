...
public class AuthController {
	...
	public ResponseEntity<String> getGoogleAuthUrl() {
		...
		String url = authorizationEndpoint + "?response_type=code" + "&client_id=" + clientId + "&redirect_uri="
				+ redirectUri + "&scope=" + scope + "&state=" + state;
	...
	public void googleAuth(HttpServletResponse response) throws IOException {
		...
		// // Pazi da koristiš
		// https://backendservice-xspx.onrender.com/login/oauth2/code/google // pravi
		// URL
	}
